...
<div id="form2" style="margin-left:60px;margin-top:30px;">
	...
	<left><input class="btn btn-primary" type="submit"  value="Show towel" name="show" ></left>
...
<?php 
	...
	{
	$query = 
	$result = mysqli_query($con,"select subcategory_id ,subcat_name,category_desc,sell_price,cost_price,quantity from category where product_id=1 ");
...
<tr>
	...
	<td><a href="show.php?id=<?php echo $product->subcategory_id;?>"></a></td>
</tr
	<?php }  }?>	
	</tbody>
  </table>
